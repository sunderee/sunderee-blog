...
return [
    ...
    */
    ...
    'name' => env('SITE_NAME', 'Sunderee Blog'),
    ...
    */
    ...
    'meta' => [
        ...
        Meta::name('description', 'Personal blog filled with things I find interesting to write about.'),
        Meta::name('keywords', 'Blog, Technology, Flutter, Dart, Node.js, Nest.js, Angular, DevOps, CyberOps'),
        Meta::name('generator', 'HydePHP v'.Hyde\Hyde::version()),
        Meta::property('site_name', env('SITE_NAME', 'Sunderee Blog')),
    ],
    ...
    */
    ...
    'authors' => [
        Author::create(
            'peteralexbizjak', // Required username
            'Peter Aleksander Bizjak', // Optional display name
            'https://sunderee.github.io/' // Optional website URL
        ),
    ],
